      ...
      ? this.setState(
          ...
          () =>
            this.passSelectedDate(
              ...
              new Date(this.props.startDate).getDate().toString() +
                " - " +
                (new Date(this.props.startDate).getMonth() + 1).toString() +
                " - " +
                new Date(this.props.startDate).getFullYear().toString(),
    ...
    return (
      <View style={this.props.isAddTodo ? styles.containerA : styles.container}>
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            this._showDateTimePicker(this.state.dateForCalendarStrip)
          }
        >
          <Text
          ...
          >
            {this.state.month}{" "}
            <Text
              style={this.props.isAddTodo ? styles.textYearA : styles.textYear}
            >
              {" "}
              {this.state.year}
            </Text>
          ...
          {this.props.isAddTodo ? (
            ...
            <Text style={{ color: "grey" }}> Your ToDos</Text>
          )}
        </TouchableOpacity>
      </View>
    );
